...
class CreateAgentAccountScreen extends StatefulWidget {
  @override
  _CreateAgentAccountScreenState createState() => _CreateAgentAccountScreenState();
}

class _CreateAgentAccountScreenState extends State<CreateAgentAccountScreen> {
